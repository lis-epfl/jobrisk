...
*keep if D3_d_risk >0
gen magic_number = D3_d_risk / (sqrt(D1_d_skills * D2_d_know))
...
save $dta/retreff_resilience_with_retreffdistances.dta ,replace
export excel using $output/retreff_resilience_with_retreffdistances.xlsx, replace firstrow(variables)  
restore
...
save $dta/retreff_resilience.dta ,replace
export excel using $output/retreff_resilience.xlsx, replace firstrow(variables)  
...
export excel using $output/retreff_risk_change_family.xlsx, replace firstrow(variables)  


/*
**************** Table Summary results retreff_resilience

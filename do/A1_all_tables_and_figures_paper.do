...
export excel using $output/figures_tables_in_the_paper/Table1_examples.xlsx, replace firstrow(variables)  
...
graphregion(color(white) lwidth(large) margin(25 3 3 3))  ytitle("") 
...
graph export $output/figures_tables_in_the_paper/Figure2a_retrAbil.png , replace width(2400) height(1800)
...
ylabel(0 "0" 2 "2" 4 "4" 6 "6" 8 "8" 10 "10") 
graph export $output/figures_tables_in_the_paper/Figure2b_retrKnow.png , replace width(2400) height(1800)
}
*
...
foreach	i in "Electrical Engineering Technicians"    {
	...
	*/
	twoway (scatter D3_d_riskN geo_mean ,  mcolor( gs12) ) ///
		...
		legend(off) graphregion(color(white))) 
	graph export "$output/figures_tables_in_the_paper/Figure3_retreff_Change_$occupation.png" , replace width(2400) height(1800)
}
}
...
export excel using $output/figures_tables_in_the_paper/Table2a_retreff_risk_change.xlsx, replace firstrow(variables)  
...
export excel using $output/figures_tables_in_the_paper/Table2b_retreff_risk_change_percentiles.xlsx, replace firstrow(variables)  
}
*
